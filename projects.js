...
//  2. заполни поля
//  3. положи превью в папку thumbs/
//  4. сохрани и сделай git push
//
//  ПОЛЯ:
...
//  thumb    — статичная картинка: "thumbs/name.jpg"  (показывается если нет preview)
//  preview  — анимация:          "thumbs/name.webm"  (необязательно, приоритет над thumb)
//  vimeo    — полная ссылка на видео
